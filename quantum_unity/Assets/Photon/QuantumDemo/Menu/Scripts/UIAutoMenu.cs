...
namespace Quantum.Demo
{
    public class UIAutoMenu : MonoBehaviour, IConnectionCallbacks, IMatchmakingCallbacks
    {
        ...
        {
            if (_localBalancingClient != null && _localBalancingClient.IsConnected == true)
            {
                _localBalancingClient.Disconnect();
            }
        ...
        {
            CustomLogger.Instance.Log($"Join room failed [{returnCode}]: '{message}'");
        }
        ...
        public void OnJoinRandomFailed(short returnCode, string message)
        {
            ...
            CustomLogger.Instance.Log($"Creating new room for '{MaxPlayers}' max players");
        }
